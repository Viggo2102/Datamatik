...
public class Hogwarts {
    public static void main(String[] args) {
        HogwartStudent h1 = new HogwartStudent("Aske", "Lademad", "Gryffindor");
        HogwartStudent h2 = new HogwartStudent("Erik", "Trylleri", "Slytherin");
        HogwartStudent h3 = new HogwartStudent("Viggo", "Andersen", "Hufflepuff");
